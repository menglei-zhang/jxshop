    ...
    <div class="form-div">
        <form action="" name="searchForm">
            ...
            <select name="cate_id">
                ...
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($_GET['cate_id']) == $vo["id"]): ?>selected="selected"<?php endif; ?></option>>|<?php echo (str_repeat("--",$vo["lev"])); echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            <tr>
                ...
                <th style="width: 30%; text-align: center;">商品名称</th>
                <th style="width: 10%; text-align: center;">货号</th>
                <th style="width: 10%; text-align: center;">价格</th>
                <th style="width: 5%; text-align: center;">上架</th>
                <th style="width: 5%; text-align: center;">推荐</th>
                <th style="width: 5%; text-align: center;">新品</th>
                <th style="width: 5%; text-align: center;">热销</th>
            ...
            <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center">
                    <a href="<?php echo U('setNumber','goods_id='.$vo['id']);?>" target="_blank" title="库存设置">库存设置</a>
                    <a href="<?php echo U('edit','goods_id='.$vo['id']);?>" title="编辑">编辑</a>
                    <a href="<?php echo U('dels','goods_id='.$vo['id']);?>" onclick="" title="回收站">删除</a></td>
