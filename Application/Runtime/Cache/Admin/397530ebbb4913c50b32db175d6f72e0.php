            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($info["parent_id"]) == $vo["id"]): ?>selected="selected"<?php endif; ?>>|<?php echo (str_repeat("--",$vo["lev"])); echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
