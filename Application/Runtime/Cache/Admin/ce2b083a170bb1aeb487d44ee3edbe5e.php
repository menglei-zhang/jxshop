    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='attr_name' maxlength="20" value='<?php echo ($info["attr_name"]); ?>' size='27' autofocus="autofocus"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="type_id">
                        <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($info["type_id"]) == $vo["id"]): endif; ?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="attr_value" id="" cols="30" rows="10"><?php echo ($info["attr_value"]); ?></textarea>
