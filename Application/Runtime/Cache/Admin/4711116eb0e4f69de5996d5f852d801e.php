...
<div id="tabbar-div">
    <p>
        ...
        <span class="tab-front" id="menu-tab"><a href="<?php echo U('role/flushAdmin');?>">刷新</a></span>
    </p>
</div>
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["parent_id"]) == "0"): ?><li class="explode" key="02_cat_and_goods" name="menu"><?php echo ($vo["rule_name"]); ?>
                        <ul>
