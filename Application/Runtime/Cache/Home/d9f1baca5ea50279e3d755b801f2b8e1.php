		...
		<table>
			...
			<tbody style="font-size: 13px;">
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td class="col1">
						<a href=""><img src="/<?php echo ($vo["goods"]["0"]["goods_thumb"]); ?>"/></a> 
						<strong><a href=""></a><?php echo ($vo["goods"]["0"]["goods_name"]); ?></a></strong>
					</td>
					<td class="col2">
					...
					<td class="col3">￥<span><?php echo ($vo["goods"]["0"]["shop_price"]); ?></span></td>
					<td class="col4"> 
					...
					<td class="col5">￥<span><?php echo ($vo['goods'][0]['shop_price']*$vo['goods_count']); ?></span></td>
					<td class="col6"><a href="<?php echo U('dels','goods_id='.$vo['goods_id'].'&goods_attr_ids='.$vo['goods_attr_ids']);?>">删除</a></td>
