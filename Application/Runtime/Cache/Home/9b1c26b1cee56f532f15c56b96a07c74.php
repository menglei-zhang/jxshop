...
<div class="header w1210 bc mt15">
	...
	<div class="logo w1210">
		<h1 class="fl"><a href="index.html"><img src="/Public/Home/images/logo.png" alt="商城"></a></h1>
		<!-- 头部搜索 start -->
		<div class="search fl">
		...
		<div class="user fl">
			<dl>
				...
				<dd>
					<div class="prompt">
						您好，请<a href="<?php echo U('login');?>">登录</a>
					</div>
					...
					<ul>
						<?php if(is_array($crazy)): $i = 0; $__LIST__ = $crazy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								...
								<dd style="overflow: hidden;"><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
						...
						<ul>
							<?php if(is_array($v2["goods"])): $i = 0; $__LIST__ = $v2["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($i % 2 );++$i;?><li>
								<dl>
									...
									<dd style="overflow: hidden;"><a href="<?php echo U('Goods/index','goods_id='.$v3['id']);?>"><?php echo ($v3["goods_name"]); ?></a></dd>
