				...
				<table>
					...
					<tbody>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td class="col1">
								<a href=""><img src="/<?php echo ($vo["goods"]["0"]["goods_thumb"]); ?>" alt="" /></a>
								<strong><a href=""><?php echo ($vo["goods"]["0"]["goods_name"]); ?></a></strong>
							</td>
							<td class="col2">
							...
							<td class="col3">￥<?php echo ($vo["goods"]["0"]["shop_price"]); ?></td>
							<td class="col4"><?php echo ($vo["goods_count"]); ?></td>
							<td class="col5"><span>￥<?php echo ($vo['goods_count']*$vo['goods'][0]['shop_price']); ?></span></td>
