...
class OrderController extends CommonController
{
    ...
    public function order(){
        ...
        //     'total_price' => float 9000
        //     'name' => string '11111111' (length=8)
        //     'address' => string '北京' (length=6)
        //     'tel' => string '12' (length=2)
        //     'addtime' => int 1582205483
        //     'id' => string '39' (length=2)
        if(!$res){
            $this->error($model->getError());
        }
        // $this->success('ok',U('home/index/index'));
        // 实现具体的支付操作   pay/pagepay/service/pagepay.php
